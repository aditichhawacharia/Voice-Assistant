...
#speech_text is function inside worker.py
#openai package installed for gpt model
...
#when the user loads the application, they will go first to /endpoint, triggering the index
#the returned code from the function is a render function to show the index.html, the 
#frontend interface
...
#the second & third routes process requests and sending info between the applications
